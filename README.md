...
```bash
# 1. 克隆
git clone https://github.com/FinlayMa/pingpong-saas-springboot.git
...
# 3. 修改yml文件中的相关配置（包括数据库密码等）

# 4. 启动
mvn compile && mvn spring-boot:run
```

获取前端源码可访问文件底部链接（前端仓库地址）。
...
| 店长1 | 13800000002 | 123456 |
| 店长2 | 13800000003 | 123456 |
...
前端：https://github.com/FinlayMa/pingpong-saas-vue
